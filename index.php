                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            <div class="brand-logo" align="center">
                                <img class="img-avatar mb-3" src="companyimages/indifly_logo.png" alt="">
                            </div>
                            <form role="form" id=""  method="post" enctype="multipart/form-data" class="form-horizontal">  
                                ...
                                <div class="form-group mt-3">
                                    <input type="text" name="password" class="form-control form-control-lg" id="exampleInputPassword1" style="color: black" placeholder="Password" required>
                                </div>
                                <div class="mt-3">
