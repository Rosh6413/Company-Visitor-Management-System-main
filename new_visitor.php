                ...
                <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="row ">
                    <div class="form-group col-md-6 ">
                      <label for="exampleInputPassword1">Visitors Full Names</label>
                      <input type="text" id="fullname" name="fullname" placeholder="Full Name" class="form-control" required="">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">Visitors Email </label>
...
*/ -->
                  <div class="row ">
                    <div class="form-group col-md-6 ">
                      <label for="exampleInputPassword1">Visitors Contact Number</label>
                  ...
                  <div class="row ">
                    <div class="form-group col-md-6 ">
                      <label for="exampleInputPassword1">Pass Number</label>
                      <input type="text" id="PassNo" name="PassId" placeholder="Enter Pass Number" class="form-control" required="">
                    </div>
                    <div class="form-group col-md-6">
                  ...
                  <div class="row ">
                    <div class="form-group col-md-6 offset-md-6 ">
                      <label for="exampleInputPassword1"> Visitors Address</label>
